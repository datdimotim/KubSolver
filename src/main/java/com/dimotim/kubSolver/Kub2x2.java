...
import static com.dimotim.kubSolver.Kub2x2.KUB_ERROR.INVALID_UGOL_CUBIE;
import static com.dimotim.kubSolver.Kub2x2.KUB_ERROR.INVALID_UGOL_SUM_ORIENTATION;
import static com.dimotim.kubSolver.Kub2x2.KUB_ERROR.UGOL_ALREADY_PRESENT;
...
public class Kub2x2 {
    ...
    public Kub2x2(boolean isRandom){if(isRandom)randomPos();}
